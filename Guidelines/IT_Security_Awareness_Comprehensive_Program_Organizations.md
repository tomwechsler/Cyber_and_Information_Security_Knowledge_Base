# IT Security Awareness: A Comprehensive Program for Organizations
...
A strong **IT Security Awareness program** is not just an option; it is a **necessity** for every company (and everyone in that company, without exception).
